...
3. **Hosting: Hetzner VPS** (CX22-class, 2 vCPU/4GB, ~$5–6/mo) + Docker Compose, S3 (existing AWS bucket) for backups. Priced against Lightsail: same money buys 4× the RAM at Hetzner; same RAM costs 4–5× at AWS. AWS familiarity held zero weight per owner.
